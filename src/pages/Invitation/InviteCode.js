...
import { LEARNING_CENTER, ROOT, TASK_CENTER } from 'src/navigation/CONSTANTS';
import { findOrgByCode } from 'src/services/orgService';
import { CgProfile } from 'react-icons/cg';
import { ProfileData } from 'src/pages/LoginSignUp/ProfileData';
  ...
  return (
    <AppLayout>
      <div className="assignment-container gap-3rem">
        ...
        {!org && (<MainButton btnLabel="Search" disabled={isDisabled} onClick={handleSearch} />)}
        ...
        <div className="view-50 instruction">
          <ul>
            <li>
              New user, please enter your School Code, ex:123,  to connect with your school and teacher’s account
              so that your assignment can be marked, and you can receive your assignment and feedback from your teacher.
            </li>
            <li>
              User without a school code will be considered as an individual user,
              and can still use our platform to boost your speaking English.
            </li>
          </ul>
        </div>
      </div>
