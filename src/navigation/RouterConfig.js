...
const LoginPageContainer = lazy(() =>
  import(/* webpackChunkName: "LoginPageContainer" */ '../pages/LoginSignUp/LoginPageContainer'))

const LeaderboardContainer = lazy(() =>
  import(/* webpackChunkName: "LeaderboardContainer" */ '../pages/Leaderboard/LeaderboardContainer'))

const ProgressContainer = lazy(() =>
  import(/* webpackChunkName: "ProgressContainer" */ '../pages/Progress/ProgressContainer'))

const SignUp = lazy(() =>
  import(/* webpackChunkName: "SignUp" */ '../pages/LoginSignUp/SignUp'))

const ConfirmSignUp = lazy(() =>
  import(/* webpackChunkName: "ConfirmSignUp" */ '../pages/LoginSignUp/ConfirmSignUp'))
...
const TaskCenter = lazy(() =>
  import(/* webpackChunkName: "TaskCenter" */ 'src/pages/Teacher/TaskCenter/TaskCenter'))

const Classrooms = lazy(() =>
  import(/* webpackChunkName: "Classrooms" */ 'src/pages/Teacher/Management/Classrooms'))

const AdminCenter = lazy(() =>
  import(/* webpackChunkName: "AdminCenter" */ 'src/pages/Admin/AdminCenter'))

const AdminUserList = lazy(() =>
  import(/* webpackChunkName: "AdminUserList" */ 'src/pages/Admin/AdminUserList'))

const ClassroomDetail = lazy(() =>
  import(/* webpackChunkName: "ClassroomDetail" */ 'src/pages/Teacher/Management/ClassroomDetail'))
      ...
      <div>
        <Suspense fallback={<LoadingPage />}>
          <Switch>
            ...
            <PrivateRoute path={INVITATION} component={InviteCode} />

            {/* Teacher Path */}
            <PrivateRoute exact path={TASK_CENTER} component={TaskCenter} />
            <PrivateRoute path={TEACHER_STUDENT_LIST} component={ClassroomDetail} />
            <PrivateRoute path={TEACHER_CLASSROOMS} component={Classrooms} />

            {/* Admin Path */}
            <PrivateRoute exact path={ADMIN_CENTER} component={AdminCenter} />
            <PrivateRoute path={ADMIN_TEACHER_LIST} component={AdminUserList} />
            <PrivateRoute path={ADMIN_STUDENT_LIST} component={AdminUserList} />
